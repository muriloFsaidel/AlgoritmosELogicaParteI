...
function gitAndGithub(){
  ...
  const paragrafo = document.getElementById("paragrafo");
  paragrafo.style = "position: absolute; margin:10px; left: 47%; top: 120%; font-size: larger;font-weight: 700;text-shadow: -16px 15px 20px rgba(217, 212, 212, 1);background-color: rgba(51, 255, 48, 1);border: 8px dashed yellow; padding: 10px; margin-top: 20px;"
