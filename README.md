...
![GitHub Created At](https://img.shields.io/github/created-at/muriloFsaidel/AlgoritmosELogicaParteI)
![GitHub commit activity](https://img.shields.io/github/commit-activity/t/muriloFsaidel/AlgoritmosELogicaParteI)
![GitHub last commit](https://img.shields.io/github/last-commit/muriloFsaidel/AlgoritmosELogicaParteI)
![GitHub language count](https://img.shields.io/github/languages/count/muriloFsaidel/AlgoritmosELogicaParteI)

## Algoritmos e Lógica Parte I

  <p>O projeto foi concebido a partir da conclusão do curso Algoritmos e Lógica Parte I na udemy e ministrado pelo professor Cleison.<br/>
     Conteúdo do curso Algoritmos e Lógica Parte I que tem por objetivo colocar em prática conceitos e estruturas importantes na programação de modo geral, usando como instrumentos: Pseudocódigo e Javascript. A navegação dos mesmos está no github pages e repositório. 
   </p>
...
# Solução Desafios Hackerrank
	- [Solução aprendida e explicada no vídeo](https://www.youtube.com/watch?v=2HIKw9reqMg)<br>

# Explicação Geral	
   - [Solução aprendida e explicada no vídeo](https://www.youtube.com/watch?v=WQ5qixALAhg)<br>
